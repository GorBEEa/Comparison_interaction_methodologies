...
Metabarcoding also has some limitations. Primer and marker biases result in preferential amplification of certain sequences, making some taxa more or less likely to appear in final results. This limits the quantification of metabarcoding data, as was reflected in our binary treatment of these data. This approach may have both exaggerated and understated the roles of certain plant taxa as food resources, given our inability to use the relative abundance of reads as reliable quantified data [@bell2018]. Additionally, we used the ITS region as a target for amplicon sequencing because of its dual utility in identifying plant and fungal taxa. Other marker genes with reference sequence databases specific to plant taxa, such as *rbcL*, may have had better coverage of available sequences for matching our data to ASVs and taxa. In response to these limitations, we further suggest that combination with other interaction methodologies is likely to be the most effective way to overcome inherent methodological oversights.
