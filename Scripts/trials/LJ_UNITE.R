#Script for viewing LJ's UNITE assign_tax results
...
bp.asv.counts.2023 <- read_tsv(here("Data/LJU_2023_plant_prj_ASVs_counts.tsv"))
bp.asv.tax.2023 <- read_tsv(here("Data/LJU_2023_plant_prj_ASVs_taxonomy.tsv"))
